...
class RsRankingItem(BaseModel):
    ...
    return_1m: Decimal | None = Field(default=None, description="1개월 종가 수익률 (내부 검증용)")
    return_3m: Decimal = Field(description="3개월 종가 수익률 (내부 검증용)")
    return_6m: Decimal = Field(description="6개월 종가 수익률 (내부 검증용)")
    return_9m: Decimal = Field(description="9개월 종가 수익률 (내부 검증용)")
    return_12m: Decimal = Field(description="12개월 종가 수익률 (내부 검증용)")
    rs_1m: int = Field(default=0, description="1개월 RS Rating (1~99)")
    rs_3m: int = Field(default=0, description="3개월 RS Rating (1~99)")
    rs_6m: int = Field(default=0, description="6개월 RS Rating (1~99)")
    rs_12m: int = Field(default=0, description="12개월 RS Rating (1~99)")
